...
final class DepthRenderer {
    ...
    private struct Uniforms {
        ...
        var light: SIMD4<Float> // dim floor, strength, reach, reserved
        var mode: SIMD4<Float> // progress, effect index, reserved, reserved
    }
    ...
    func render(
        ...
        var uniforms = Uniforms(
            ...
            mode: SIMD4(Float(progress), Float(effect.shaderIndex), 0, 0)
        )
